...
final class LazyProduct {
  LazyProduct({required this.id, required this.name, required this.brandId, required this.categoryId});
  ...
  Product toProduct(Brand brand, Category category) => Product(id: id, name: name, brand: brand, category: category);
}
